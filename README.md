...
[![CI](https://github.com/sylph520/ohmyzsh/workflows/CI/badge.svg)](https://github.com/sylph520/ohmyzsh/actions?query=workflow%3ACI)
...
- [Zsh](https://www.zsh.org) should be installed (v4.3.9 or more recent is fine but we prefer 5.0.8 and
  ...
  [Installing ZSH](https://github.com/sylph520/ohmyzsh/wiki/Installing-ZSH)
...
| Method    | Command                                                                                           |
| :-------- | :------------------------------------------------------------------------------------------------ |
| **curl**  | `sh -c "$(curl -fsSL https://raw.githubusercontent.com/sylph520/ohmyzsh/customizations/tools/install.sh)"` |
| **wget**  | `sh -c "$(wget -O- https://raw.githubusercontent.com/sylph520/ohmyzsh/customizations/tools/install.sh)"`   |
| **fetch** | `sh -c "$(fetch -o - https://raw.githubusercontent.com/sylph520/ohmyzsh/customizations/tools/install.sh)"` |
...
```sh
wget https://raw.githubusercontent.com/sylph520/ohmyzsh/customizations/tools/install.sh
sh install.sh
```
...
[plugins](https://github.com/sylph520/ohmyzsh/tree/master/plugins) directory and/or the
[wiki](https://github.com/sylph520/ohmyzsh/wiki/Plugins) to see what's currently available.
...
[screenshots](https://github.com/sylph520/ohmyzsh/wiki/Themes) on the wiki (We are working on updating this!).
Check them out!
...
# see https://github.com/sylph520/ohmyzsh/wiki/Themes#agnoster
```
...
> [the FAQ](https://github.com/sylph520/ohmyzsh/wiki/FAQ#i-have-a-weird-character-in-my-prompt) for more
> information.
>
...
> [what is a zsh theme](https://github.com/sylph520/ohmyzsh/wiki/FAQ#what-is-a-zsh-theme).
<!-- prettier-ignore-end -->
...
[more of them](https://github.com/sylph520/ohmyzsh/wiki/External-themes).
...
[FAQ](https://github.com/sylph520/ohmyzsh/wiki/FAQ).
...
```sh
sh -c "$(curl -fsSL https://raw.githubusercontent.com/sylph520/ohmyzsh/master/tools/install.sh)" "" --unattended
```
...
- `REPO` (default: `sylph520/ohmyzsh`): this takes the form of `owner/repository`. If you set this variable,
...
```sh
git clone https://github.com/sylph520/ohmyzsh.git ~/.oh-my-zsh
```
...
> ```
>
> See more options in the [FAQ: How do I update Oh My Zsh?](https://github.com/sylph520/ohmyzsh/wiki/FAQ#how-do-i-update-oh-my-zsh).
>
...
[the open issues](https://github.com/sylph520/ohmyzsh/issues) and help where you can.
...
[external themes](https://github.com/sylph520/ohmyzsh/wiki/External-themes) wiki page.
...
<a href="https://github.com/sylph520/ohmyzsh/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=sylph520/ohmyzsh" width="100%"/>
</a>
